...
| ------------------------------------- | ------------------------------------ |
| ![alt text](readme_assets/before.png) | ![alt text](readme_assets/after.png) |

|           항목           | 웹 성능 최적화 전 | 웹 성능 최적화 후 |
| :----------------------: | :---------------: | :---------------: |
|    Performance Score     |        61         |        98         |
|  First Contentful Paint  |       3.6s        |       0.7s        |
|       Speed Index        |       3.6s        |       1.1s        |
|   Total Blocking Time    |       110ms       |       50ms        |
| Largest Contentful Paint |       3.6s        |       1.1s        |
| Cumulative Layout Shift  |       0.032       |       0.032       |

- '지연 로딩(Lazy Loading)' 적용
- png 파일들을 webp 파일들로 교체
- 불필요한 JS 파일 제거

> 위의 작업들을 통해 Performance Score 61점 → 98점으로 개선, Speed Index 속도 3.6초 → 1.1초로 개선
